  ...
  return (
    ...
    <Center>
        <Box h="16rem" w="16rem" p="1rem" bg="white" style={{ borderRadius: "0.2rem", boxShadow: "rgba(0, 0, 0, 0.35) 0px 5px 15px" }}>
          ...
          <br />
          <br />
          <Box w="14rem" h="1.5rem" as="button" bg="red" color="white" style={{ borderRadius: "0.2rem" }}>SignIn</Box>
          <br />
          <br />
          <Link to="/SignUp">
            <Box w="14rem" h="1.5rem" as="button" color="red" border="1px solid #E5383B" style={{ borderRadius: "0.2rem" }}>SignUp</Box>
          </Link>
        </Box>
      </Center>
    </>
