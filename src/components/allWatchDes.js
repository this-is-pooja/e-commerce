      ...
      <Flex p="4rem" mr="3rem">
        <HStack>
          ...
          <Box>
            ...
            <br />
            <Link to={{ pathname: '/cart', hash: '', search: `img=${img}&price=${price}` }}><Box w="6.5rem" h="1.5rem" as="button" color="white" bg="red" style={{ borderRadius: "0.2rem" }}>add to cart</Box></Link>
          </Box>
        </HStack>
      </Flex>
    </>
